...
SECRET_KEY = 'django-insecure-vdhiw@7^#atpo(h5@ac&6azx@adc(s!x2)+lh#4cp#=sk0(1&j'
...
CORS_ALLOWED_ORIGINS = [
    "http://localhost:8001",  # Frontend server URL
    "http://192.168.18.133:8001",  # Frontend server URL
]
...
ROOT_URLCONF = 'football_catalog.urls'
...
WSGI_APPLICATION = 'football_catalog.wsgi.application'
